          ...
          stakingLevel.level > 1 ? (
            <div className="mt-4">
              ...
              <div className="mt-6">
                {balanceNeeded > 0 && !isInfinityLevel && (
                  <p className="text-sm">
                    Your Staking Tier is <span className="text-error font-bold">{stakingLevel?.level}</span>. <br/> You need <span className="text-error font-bold">{balanceNeeded.toFixed(2)}</span> BRICSQFS more to reach next Staking tier!
                  </p>
                )}
              </div>
            ...
            <div className="text-center space-y-4">
              <h1 className="text-base font-semibold text-gray-200">
                BRICSQFS Balance: <span className="text-primary">{Number(mainTokenBalance).toFixed(0)}</span>
              </h1>
              <h2 className="text-base font-semibold text-gray-200">
                Staking is available from <span className="text-primary">300K+</span> BRICSQFS hold.
              </h2>
            </div>
          )
        ) : (

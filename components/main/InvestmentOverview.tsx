          ...
          <>
            ...
            <MyCard glow='info'>
              <div className="text-center">
                <div className="text-sm text-gray-200 mb-2">BRICSQFS Balance</div>
                ...
                {!isInfinityLevel && (
                  <div className="space-y-2">
                    <div className="flex justify-between text-xs text-gray-200">
                      <span>{userLevel.start.toLocaleString()} BRICSQFS</span>
                      <span>{userLevel.end.toLocaleString()} BRICSQFS</span>
                    </div>
                ...
                <div className="mt-4 pt-4 border-t border-gray-200">
                  ...
                  {(balanceNeeded > 0 && !isInfinityLevel) && (
                    <div className="text-sm text-gray-200 mb-3">
                      Need <span className="font-bold text-info">{balanceNeeded.toLocaleString()}</span> more BRICSQFS to reach Tier {userLevel.level + 1}
                    </div>
                  )}
                  <button

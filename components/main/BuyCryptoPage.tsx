          ...
          {!isDiscountable && (
            <MyCard className="text-center mb-4">
              <div className="space-y-4">
                <div>
                  <div className="text-sm text-gray-200 mb-2">Your BRICSQFS Balance</div>
                ...
                <div className="pt-4 border-t border-gray-200">
                  <div className="text-sm text-gray-300 leading-relaxed">
                    ...
                    <span className="font-bold text-gray-300">{getMinDiscountableHoldAmount().toLocaleString()}+</span> BRICSQFS .
                  </div>
                  <button
